          ...
          orders: [
              {
                  ...
                  photo: "https://spicebasket.com/cdn/shop/products/idly-mix-naturally-fermented-300g-453964.jpg?v=1688466743",
                  itemName: "Idly",
                  quantity: 2,
                ...
                },
                {
                  ...
                  photo: "https://www.cookwithmanali.com/wp-content/uploads/2020/05/Masala-Dosa.jpg",
...
function UserHistory() {
  ...
  const [history] = useState(data.orderHistory);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
        <div>
          ...
          <div className="bg-white dark:bg-[#181818] p-5 rounded-lg shadow-lg">
            {totalOrders.currentOrders[0].orders.length > 0 ? (
