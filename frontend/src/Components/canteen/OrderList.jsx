  ...
  return (
    <div className="w-[20%] h-screen overflow-scroll border-2 border-green-950 bg-green-100 dark:bg-[#181818]">
      <div className="h-fit flex gap-4 flex-col justify-center items-center">
        <h1 className="text-green-900 dark:text-green-200 font-bold text-2xl mt-4">Order List</h1>
            ...
            >
              ...
              <div className="flex flex-col justify-center mt-2">
                <div className="flex mx-3 w-fit h-fit justify-evenly">
                  ...
                  <p className="text-[1.1rem] text-green-900 dark:text-green-200">{element.usn}</p>
                </div>
                <div className="text-[1.1rem] mb-2 h-fit flex justify-center items-center">
                  <p className="text-green-900 dark:text-green-200">Arrival Time :</p>
                  <p className="text-green-900 dark:text-green-200 ml-1">{element.arrivalTime}</p>
                </div>
              </div>
            </div>
          );
