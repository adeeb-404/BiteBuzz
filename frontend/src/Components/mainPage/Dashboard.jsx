...
function Dashboard({ index }) {
  ...
  if (index == null) {
    return (
      <div className="hidden md:block md:w-full m-5 h-full overflow-hidden ">
  ...
  return (
    <div className="hidden md:block md:w-full h-full m-5 overflow-scroll ">
      <div className="mx-4 border-4 border-black md:h-[38rem] rounded-3xl bg-gray-100 flex p-3 flex-col gap-10">
        <div className="flex h-[60%]">
          <div className="w-[70%] h-full">
            ...
            <img
              ...
              alt="canteen image"
              className="h-full w-[90%] p-3 rounded-2xl"
            />
          </div>
          ...
          <div className="w-[30%] h-auto flex flex-col gap-5">
            ...
            <h1 className="flex flex-row items-center">
              ...
              <FaStar className="size-3 m-1" />
            </h1>
          </div>
        </div>

        <div className="h-[25%]">
          <h1 className="py-5 font-bold text-[1.1rem]">Popular Dishes : </h1>
          <div className="flex gap-5 justify-center">
            {canteenInfo[index].top5.map((foods, ind) => {
              return (
                <div
                  key={ind}
                  className="border bg-gray-300 h-[8rem] w-[8rem] flex flex-col items-center rounded-md justify-around"
                >
