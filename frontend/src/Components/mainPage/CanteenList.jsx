...
function MainPage(){
    ...
    const canteenInfo = [{name:"Srikantu",img:canteen1},
    ...
    return(
        <div className="w-[20%] px-5 text-center border-r border-black box-content">
            ...
            {canteenInfo.map((element) => {
                return(
                    <div className="group bg-[#ededed] my-4 w-[99%] h-[15rem] flex items-center justify-center flex-col rounded-md cust-canteen-hover">
                        <img src={element.img} alt="canteen" className="box-border h-[10rem] w-[12rem] rounded-sm group-hover:border-white group-hover:shadow-glow" />     
